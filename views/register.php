            ...
            <div class="card-body">
                <form action="../actions/register-action.php" method="post" autocomplete="off">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="password" name="password" id="password" class="form-control" minlength 
                        required aria-describedBy="password-info">
                ...
                <p class="text-center small nt-3">Registerd already?<a href="../views">Login</a></p>
            </div>
        </div>
    </div>
